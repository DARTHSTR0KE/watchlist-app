...
// How to write a score from the watched table: 4 rather than "4.0", but
// 4.5 keeps its half. Ratings arrive from ratings.csv on import; nothing
// in the app sets one.
...
// Where a veto applies: the shared list is the one about both people, so a
